...
export default function InformeTiempo({ navigation }) {
    ...
    const [promedioGastos, setPromedioGastos] = useState(0);
    ...
    const handleSelectChange = (itemValue) => {
        ...
        .then(data => {
            console.log(data);
            const promedioGastos = data[0].map(item => item.PromedioRecursosEconomicos);
            if (promedioGastos[0]==null) {
                setPromedioGastos(0);
            } else {
                setPromedioGastos(promedioGastos);
            }
    ...
    return (
        <View style={styles.backgroundStyle}>
            ...
            <View style={styles.box}>
                <Text style={styles.label}>Promedio de gastos del proyecto:</Text>
                <Text style={styles.label}>{promedioGastos} dólares</Text>
            </View>
